            ...
            <div className="bg-white/5 backdrop-blur-sm border border-white/10 rounded-2xl p-8 shadow-2xl">
              <div className="relative">
                <textarea
                  ...
                  className="w-full h-48 bg-black/30 text-white placeholder:text-white/40 border border-white/10 rounded-xl p-4 pr-28 resize-none focus:outline-none focus:ring-2 focus:ring-emerald-500/40 transition-all"
                />
